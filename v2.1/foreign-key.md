...
> CREATE TABLE orders_3 (
  id INT PRIMARY KEY,
  customer_id INT REFERENCES customers_3 (id) ON DELETE SET NULL ON UPDATE SET NULL
);
~~~
...
> CREATE TABLE orders_4 (
  id INT PRIMARY KEY,
  customer_id INT DEFAULT 9999 REFERENCES customers_4 (id) ON DELETE SET DEFAULT ON UPDATE SET DEFAULT
);
~~~
